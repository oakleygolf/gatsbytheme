...
To shadow/override this theme, you will need to place your files into `src/@easycheck/gatsby-theme-docs` folder.
...
```js title=src/@easycheck/gatsby-theme-docs/components/Logo.js
...
Create a file at `src/@easycheck/gatsby-theme-docs/text/index.mdx` to edit the text. Example:

```mdx title=src/@easycheck/gatsby-theme-docs/text/index.mdx
# Introduction

My awesome project!

import Navigation from '@easycheck/gatsby-theme-docs/src/components/Docs/PostNav';
...
We use Emotion for theming. To change the theme colors, create a file under `src/@easycheck/gatsby-theme-docs/styles/theme.js`.

Remember that you need to restart your server to see the update.

```js title=src/@easycheck/gatsby-theme-docs/styles/theme.js
export default {
  colors: {
    primary: '#8257E6',
    background: '#FFFFFF',
...
To do this, create a file under `src/@easycheck/gatsby-theme-docs/styles/theme.js` (or add to the existing default object if you already started customizing the theme).
...
```js title=src/@easycheck/gatsby-theme-docs/components/Code/LiveCodeScope.js
